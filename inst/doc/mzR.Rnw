...
package \citep{Rcpp11}. Where possible \Rpackage{mzR} selects the appropriate backend for the 
...
functionality to access the full metadata stored in an \texttt{mzML} file, 
